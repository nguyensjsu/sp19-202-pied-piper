...
public class LeaderBoardScreen extends World
{
    ...
    {
        String inputValue = JOptionPane.showInputDialog("Please input Name");
        ...
        try{
            ...
            input = input + inputValue + "," + inputScore + ";"; // new name and score
            String strArraytemp[] = input.split(";");
                
            writefile(input);
            
            if(strArraytemp.length<11)
            {
                for(int i=0; i < 10-strArraytemp.length; i++){
                input=input + "unknown,0;";
                }
            }
